...
//    nodes = [
//        {"id": 0,"plinks":1, "fixed": 1, "x": 60, "y": 65, "nodeWeight": 1, "index": 0, "weight": 2, "px": 60, "py": 65},
//        {"id": 1,"plinks":1, "fixed": 1, "x": 219, "y": 65, "nodeWeight": 1, "index": 1, "weight": 3, "px": 219, "py": 65},
//        {"id": 2,"plinks":1, "fixed": 1, "x": 374, "y": 294, "nodeWeight": 1, "index": 2, "weight": 2, "px": 374, "py": 294},
//        {"id": 3,"plinks":1, "fixed": 1, "nodeWeight": 1, "x": 105.5, "y": 293, "index": 3, "weight": 3, "px": 105.5, "py": 293}
//    ];
//    lastNodeId = 3;
//    links = [
//        {"source": nodes[0], "target": nodes[1], "left": false, "right": true, "linkWeight": 1},
//        {"source": nodes[1], "target": nodes[2], "left": false, "right": true, "linkWeight": 1},
//        {"source": nodes[2], "target": nodes[3], "left": true, "right": false, "linkWeight": 1},
//        {"source": nodes[0], "target": nodes[3], "left": false, "right": true, "linkWeight": 1},
...
//    createNodeWeightsTable("#node-weights", nodes, ["id", "nodeWeight", "plinks"], ["node", "weight", "links"]);
...
//                    if (type == "node") {
//                        nodes[node].nodeWeight = newContent;
//                        console.log(nodes[node].nodeWeight);
//                    } else {
//                        for (i = 0; i < links.length; ++i) {
//                            var link = links[i];
...
//
//
//        $("td:nth-child(3)").dblclick(function () {
//            var OriginalContent = $(this).text();
//            var node = $(this).attr("node");
//            var source = $(this).attr("source");
//            var target = $(this).attr("target");
...
//                            if (nodes[i].id == node) {
//                                nodes[i].plinks = newContent;
//                                console.log(nodes[i].plinks);
...
//        node = {id: ++lastNodeId, fixed: 1, nodeWeight: 1, plinks:1};
//    console.log(node);
//    node.x = point[0];
//    node.y = point[1];
//    nodes.push(node);
